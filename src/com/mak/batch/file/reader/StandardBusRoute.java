...
public class StandardBusRoute {
	...
	@ObjectMapping(position = 2, isCustomObject = true, className = Route.class)
	...
	@ObjectMapping(position = 1, isCustomObject = true, isList = true, className = Route.class)
